# Generated by Powerlevel10k configuration wizard on 2022-03-14 at 10:15 CET.
...
() {
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}${(g::)POWERLEVEL9K_VCS_CONFLICT_ICON}${VCS_STATUS_NUM_CONFLICTED}"
